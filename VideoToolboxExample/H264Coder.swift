...
//  VidDel
//
//  Created by michal on 21/10/2020.
...
//        print(sampleBuffer, "copied", copiedSampleBuffer.pointee!)
    ...
    static func getDataFrom(_ buffer: CMBlockBuffer) -> (Data, Int) {
        ...
        let state = CMBlockBufferGetDataPointer(buffer, atOffset: 0, lengthAtOffsetOut: &length, totalLengthOut: &totalLength, dataPointerOut: &dataPointer)
...
//        print("dataPointer", dataPointer)
    ...
    static func attachments(from sampleBuffer: CMSampleBuffer) {
        ...
        for i in 0..<numValues {
            ...
            let keys = dict.allKeys as! [CFString]
            let values = dict.allValues as! [CFBoolean]
        }
    }
